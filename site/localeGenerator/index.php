...
<html>
<head>
<title>Random locale generator</title>
...
<body style="background-color: #edefd3;">
	<div id="container">
		<div id="header">
			<h3>Built from DMG charts; generate ten strange monuments and the locales near them</h3>
		</div>
		<div id="body">
			<button id="btn">Generate some weirdness</button>
			<div id="results"></div>
		</div>
	</div>
</body>	
...
<script type="text/javascript">
	...
	button.addEventListener('click', function() {
		console.log("hit click");
  		...
  		getRequest('localeGenerator.php',
  			function(response){
